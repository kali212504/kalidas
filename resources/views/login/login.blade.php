...
<!--===============================================================================================-->	
	<link rel="icon" type="{{('public/login/image/png')}}" href="images/icons/favicon.ico"/>
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: {{('public/login/images/bg-01.jpg') 
			}};">
		...
		<!-- 				<div class="contact100-form-checkbox">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="button" id="Login" name="Login" value="Login">
					</div>
				</form>
			</div>
		</div>
